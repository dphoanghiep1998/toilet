...
class NativeAdMediumView(context: Context, attrs: AttributeSet?) : MLBBaseNativeAdView(context, attrs) {

    var mViewBinding: MlbViewGoogleBignativeBinding =
        MlbViewGoogleBignativeBinding.inflate(LayoutInflater.from(context) , this , true)
    ...
    override fun getShimerView(): ShimmerFrameLayout = mViewBinding.shrimmer.shimmerViewGift
