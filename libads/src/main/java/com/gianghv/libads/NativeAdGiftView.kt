...
class NativeAdGiftView(context: Context, attrs: AttributeSet?) : MLBBaseNativeAdView(context, attrs) {

    var mViewBinding: MlbViewGoogleBigNativeGiftBinding =
        MlbViewGoogleBigNativeGiftBinding.inflate(LayoutInflater.from(context) , this , true)
