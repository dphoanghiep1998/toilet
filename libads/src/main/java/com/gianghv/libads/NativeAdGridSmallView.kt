...
import com.gianghv.libads.databinding.MlbViewGoogleSmallnativeBinding

class NativeAdGridSmallView(context: Context, attrs: AttributeSet?) : MLBBaseNativeAdView(context, attrs) {

    var mViewBinding: MlbViewGoogleSmallnativeBinding =
        MlbViewGoogleSmallnativeBinding.inflate(LayoutInflater.from(context) , this , true)
