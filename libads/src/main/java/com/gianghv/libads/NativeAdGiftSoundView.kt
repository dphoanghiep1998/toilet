...
import com.gianghv.libads.databinding.MlbViewGoogleBigNativeGiftSoundBinding
import com.gianghv.libads.databinding.MlbViewGoogleBignativeBinding

class NativeAdGiftSoundView(context: Context, attrs: AttributeSet?) : MLBBaseNativeAdView(context, attrs) {

    var mViewBinding: MlbViewGoogleBigNativeGiftSoundBinding =
        MlbViewGoogleBigNativeGiftSoundBinding.inflate(LayoutInflater.from(context) , this , true)
