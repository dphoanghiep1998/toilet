...
class NativeAdHomeView(context: Context, attrs: AttributeSet?) : MLBBaseNativeAdView(context, attrs) {

    var mViewBinding: MlbViewGoogleBigNativeHomeBinding =
        MlbViewGoogleBigNativeHomeBinding.inflate(LayoutInflater.from(context) , this , true)
